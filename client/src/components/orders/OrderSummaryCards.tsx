  ...
  return (
    <div className="flex flex-col sm:grid sm:grid-cols-3 gap-3 sm:gap-5 mb-6 sm:mb-8 animate-slide-up">
      ...
      {!isDriver && (
        <div className="order-1 sm:order-3 flex-shrink-0 w-[85vw] sm:w-auto snap-center sm:snap-align-none h-full">
          <Link to="/dashboard" className="block group h-full">
            ...
            <div className="grid grid-cols-2 gap-1.5 sm:gap-3 mb-3 sm:mb-5 pt-2 sm:pt-4 border-t border-orange-200/50 dark:border-orange-900/30">
              <div className="bg-orange-100/50 dark:bg-orange-950/20 rounded-md sm:rounded-lg p-1.5 sm:p-2 border border-orange-200/50 dark:border-orange-900/20">
            ...
            {/* CTA button */}
            <div className="flex items-center justify-center gap-1.5 sm:gap-2 px-3 py-1.5 sm:py-2.5 bg-gradient-to-r from-orange-500 to-amber-500 text-white font-bold text-[11px] sm:text-sm rounded-md sm:rounded-xl shadow shadow-orange-200 dark:shadow-none group-hover:from-orange-600 group-hover:to-amber-600 transition-all duration-200 w-full mt-auto">
      ...
      <div className="order-2 sm:order-1 flex-shrink-0 w-[85vw] sm:w-auto snap-center sm:snap-align-none">
        <Card className="rounded-xl sm:rounded-2xl border border-border bg-card/60 backdrop-blur-xl shadow-sm hover:shadow-md transition-all duration-300 h-full flex flex-col overflow-hidden">
        <CardContent className="p-3 sm:p-5 flex flex-col flex-grow">
          ...
          <div className="flex items-end gap-1.5 mb-3 sm:mb-6 mt-auto">
          ...
          <div className="grid grid-cols-2 gap-1.5 sm:gap-3 pt-2 sm:pt-4 border-t border-border mt-auto">
